...
<%@include file="/includes.jsp"%>	  
	...
	<trh:body>
		<tr:form>			
		<br/>
		   <tr:panelGroupLayout rendered="#{securityManager.userLogged}" partialTriggers="cmdRefresh">
		   ...
		   <tr:panelGroupLayout rendered="#{not securityManager.userLogged}">
		      <tr:outputText value="Você precisa efetuar o login para visualizar suas compras."></tr:outputText>
		      <tr:commandLink text="Efetuar Login" action="login"></tr:commandLink>
		   </tr:panelGroupLayout>
		</tr:form>
	</trh:body>
	</trh:html>
