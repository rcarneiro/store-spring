...
<f:view>
	...
	<trh:body>
		<tr:form>
		<br/>
		<tr:panelGroupLayout rendered="#{securityManager.userLogged}">
			...
			<tr:panelGroupLayout rendered="#{not securityManager.userLogged}">
			    <tr:outputText value="Você precisa estar logado para acessar essa página."></tr:outputText>
				<tr:goLink destination="/login.jsp" text="Login" />
			</tr:panelGroupLayout>
		</tr:form>
	</trh:body>
	</trh:html>
